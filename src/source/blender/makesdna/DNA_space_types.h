 ...
 */
typedef struct SpaceAgentBubble {
  SpaceLink *next, *prev;
  ListBase regionbase;
  char spacetype;
  char link_flag;
...
/** Texturing Baking Space - Texture baking and export options. */
typedef struct SpaceBaking {
  SpaceLink *next, *prev;
  ListBase regionbase;
  char spacetype;
  char link_flag;
...
/**
 * Texture Sets Space for managing texture sets per material slot.
 * Provides Substance Painter-style texture set management.
 */
typedef struct SpaceTextureSets {
  SpaceLink *next, *prev;
  ListBase regionbase;
  char spacetype;
  char link_flag;
  ...
  /** Active texture set index (corresponds to material slot). */
  int active_texture_set_index;
  char _pad[4];
} SpaceTextureSets;
