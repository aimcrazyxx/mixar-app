...
const EnumPropertyItem rna_enum_space_type_items[] = {
    ...
    {SPACE_BAKING,
     "BAKING",
     ICON_RENDER_RESULT,
     "Texturing Baking Space",
     "Texture baking and processing operations"},
    {SPACE_TEXTURE_SETS,
     "TEXTURE_SETS",
     ICON_MATERIAL,
     "Texture Sets",
...
static void rna_def_space_agent_bubble(BlenderRNA *brna)
{
  ...
  srna = RNA_def_struct(brna, "SpaceAgentBubble", "Space");
  RNA_def_struct_sdna(srna, "SpaceAgentBubble");
  RNA_def_struct_ui_text(
      srna,
      "Agent Bubble Space",
 ...
 *
 * Minimal struct definition: no properties beyond what the base
 * ``Space`` class already exposes — ``draw_handler_add`` is a classmethod
 * inherited from there. */
static void rna_def_space_topbar(BlenderRNA *brna)
{
  StructRNA *srna;

  srna = RNA_def_struct(brna, "SpaceTopBar", "Space");
...
static void rna_def_space_baking(BlenderRNA *brna)
{
  ...
  srna = RNA_def_struct(brna, "SpaceBaking", "Space");
  RNA_def_struct_sdna(srna, "SpaceBaking");
  RNA_def_struct_ui_text(srna, "Texturing Baking Space", "Texture baking and processing operations");
}

static void rna_def_space_texture_sets(BlenderRNA *brna)
{
  StructRNA *srna;

  srna = RNA_def_struct(brna, "SpaceTextureSets", "Space");
  RNA_def_struct_sdna(srna, "SpaceTextureSets");
  RNA_def_struct_ui_text(srna, "Texture Sets Space", "Texture sets management");
}
