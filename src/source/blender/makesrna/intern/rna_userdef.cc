...
static void rna_userdef_theme_update(Main *bmain, Scene *scene, PointerRNA *ptr)
{
  ...
  /* Theme changes can affect region sizes (e.g. footer padding).
   * Send screen notification to trigger region layout recalculation. */
...
static void rna_def_userdef_theme_space_mixie_chat(BlenderRNA *brna)
{
  ...
  prop = RNA_def_property(srna, "chat_user_bubble", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "chat_user_bubble");
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(prop, "User Bubble", "Background color for user message bubbles");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  prop = RNA_def_property(srna, "chat_bubble_hover", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "chat_bubble_hover");
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(prop, "Bubble Hover", "Background color when hovering over interactive bubbles");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_user_text", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "chat_user_text");
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(prop, "User Text", "Text color for user messages");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_agent_text", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "chat_agent_text");
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(prop, "Agent Text", "Text color for agent messages");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_input_bg", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "chat_input_bg");
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(prop, "Input Background", "Background color for the chat input field");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(
      prop, "Mode Button Active", "Background color for the active mode button");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_button_bg", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "chat_button_bg");
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(prop, "Button Background", "Background color for chat buttons");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_button_text", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "chat_button_text");
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(prop, "Button Text", "Text color for chat buttons");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_button_hover", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "chat_button_hover");
  RNA_def_property_array(prop, 4);
  ...
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(prop, "Label Color", "Color for chat labels and secondary text");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  prop = RNA_def_property(srna, "chat_plan_toggle_on", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "chat_plan_toggle_on");
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(prop, "Plan Toggle On", "Track color for the plan mode toggle when enabled");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_placeholder_text", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "chat_placeholder_text");
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(prop, "Placeholder Text", "Color for placeholder text in input fields");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_thumbnail_border", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "chat_thumbnail_border");
  RNA_def_property_array(prop, 4);
  ...
  RNA_def_property_array(prop, 4);
  RNA_def_property_float_array_default(prop, default_send_icon_gradient_start);
  RNA_def_property_ui_text(
      prop, "Send Icon Gradient Start", "Start color for the send button icon gradient (top-left)");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_send_icon_gradient_end", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_array(prop, 4);
  RNA_def_property_float_array_default(prop, default_send_icon_gradient_end);
  RNA_def_property_ui_text(
      prop, "Send Icon Gradient End", "End color for the send button icon gradient (bottom-right)");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_send_arrow_color", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_array(prop, 4);
  RNA_def_property_float_array_default(prop, default_send_arrow_color);
  RNA_def_property_ui_text(
      prop, "Send Arrow Color", "Color of the arrow shape in the send button icon");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  /* Chat-specific sizing */
  prop = RNA_def_property(srna, "chat_footer_bottom_padding", PROP_INT, PROP_PIXEL);
  RNA_def_property_int_sdna(prop, nullptr, "chat_footer_bottom_padding");
  RNA_def_property_range(prop, 0, 20);
  RNA_def_property_int_default(prop, 6);  /* Default: 6 pixels */
  RNA_def_property_ui_text(
      prop, "Footer Bottom Padding", "Padding below the input row in the footer (in pixels)");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  /* Chat interface spacing/sizing properties */
  prop = RNA_def_property(srna, "chat_font_size", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_font_size");
  RNA_def_property_range(prop, 8.0f, 32.0f);
  RNA_def_property_float_default(prop, 14.0f);
  RNA_def_property_ui_text(prop, "Chat Font Size", "Font size for chat messages");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_label_font_size", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_label_font_size");
  RNA_def_property_range(prop, 6.0f, 24.0f);
  RNA_def_property_float_default(prop, 11.0f);
  RNA_def_property_ui_text(prop, "Chat Label Font Size", "Font size for chat labels");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_padding", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_padding");
  RNA_def_property_range(prop, 0.0f, 64.0f);
  RNA_def_property_float_default(prop, 16.0f);
  RNA_def_property_ui_text(prop, "Chat Padding", "General padding for chat interface");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  RNA_def_property_range(prop, 0.0f, 64.0f);
  RNA_def_property_float_default(prop, 14.0f);
  RNA_def_property_ui_text(prop, "Bubble Spacing", "Vertical spacing between message bubbles");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_bubble_h_padding", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_bubble_h_padding");
  RNA_def_property_range(prop, 0.0f, 64.0f);
  RNA_def_property_float_default(prop, 16.0f);
  RNA_def_property_ui_text(
      prop, "Bubble Horizontal Padding", "Horizontal padding inside message bubbles");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_bubble_v_padding", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_bubble_v_padding");
  RNA_def_property_range(prop, 0.0f, 64.0f);
  RNA_def_property_float_default(prop, 14.0f);
  RNA_def_property_ui_text(prop,
  ...
  prop = RNA_def_property(srna, "chat_corner_radius", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_corner_radius");
  RNA_def_property_range(prop, 0.0f, 32.0f);
  RNA_def_property_float_default(prop, 8.0f);
  RNA_def_property_ui_text(prop, "Corner Radius", "Corner radius for chat UI elements");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  RNA_def_property_ui_text(prop, "Label Height", "Height of chat labels");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_image_max_width", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_image_max_width");
  RNA_def_property_range(prop, 100.0f, 800.0f);
  RNA_def_property_float_default(prop, 240.0f);
  RNA_def_property_ui_text(prop, "Image Max Width", "Maximum width for chat images");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_image_max_height", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_image_max_height");
  RNA_def_property_range(prop, 100.0f, 600.0f);
  RNA_def_property_float_default(prop, 180.0f);
  RNA_def_property_ui_text(prop, "Image Max Height", "Maximum height for chat images");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_image_margin", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_image_margin");
  RNA_def_property_range(prop, 0.0f, 32.0f);
  RNA_def_property_float_default(prop, 8.0f);
  RNA_def_property_ui_text(prop, "Image Margin", "Margin around chat images");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_image_corner_radius", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_image_corner_radius");
  RNA_def_property_range(prop, 0.0f, 32.0f);
  RNA_def_property_float_default(prop, 12.0f);
  RNA_def_property_ui_text(prop, "Image Corner Radius", "Corner radius for images in chat bubbles");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_thumbnail_border_radius", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_thumbnail_border_radius");
  RNA_def_property_range(prop, 0.0f, 32.0f);
  RNA_def_property_float_default(prop, 8.0f);
  RNA_def_property_ui_text(prop, "Thumbnail Border Radius", "Border radius for image thumbnail previews");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_thumbnail_padding", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_thumbnail_padding");
  RNA_def_property_range(prop, 0.0f, 16.0f);
  RNA_def_property_float_default(prop, 4.0f);
  RNA_def_property_ui_text(prop, "Thumbnail Padding", "Padding inside image thumbnail previews");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_action_button_height", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_action_button_height");
  RNA_def_property_range(prop, 16.0f, 48.0f);
  RNA_def_property_float_default(prop, 24.0f);
  RNA_def_property_ui_text(prop, "Action Button Height", "Height of action buttons");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_action_button_padding", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_action_button_padding");
  RNA_def_property_range(prop, 0.0f, 32.0f);
  RNA_def_property_float_default(prop, 8.0f);
  RNA_def_property_ui_text(prop, "Action Button Padding", "Padding inside action buttons");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_action_button_spacing", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_action_button_spacing");
  RNA_def_property_range(prop, 0.0f, 16.0f);
  RNA_def_property_float_default(prop, 6.0f);
  RNA_def_property_ui_text(prop, "Action Button Spacing", "Spacing between action buttons");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_action_button_corner_radius", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_action_button_corner_radius");
  RNA_def_property_range(prop, 0.0f, 16.0f);
  RNA_def_property_float_default(prop, 4.0f);
  RNA_def_property_ui_text(
      prop, "Action Button Corner Radius", "Corner radius for action buttons");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_footer_general_padding", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_footer_general_padding");
  RNA_def_property_range(prop, 0.0f, 32.0f);
  RNA_def_property_float_default(prop, 6.0f);
  RNA_def_property_ui_text(prop, "Footer General Padding", "General padding for footer elements");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_footer_side_padding", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_footer_side_padding");
  RNA_def_property_range(prop, 0.0f, 64.0f);
  RNA_def_property_float_default(prop, 8.0f);
  RNA_def_property_ui_text(prop, "Footer Side Padding", "Left and right padding for footer");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_footer_row_spacing", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_footer_row_spacing");
  RNA_def_property_range(prop, 0.0f, 32.0f);
  RNA_def_property_float_default(prop, 2.0f);
  RNA_def_property_ui_text(prop, "Footer Row Spacing", "Vertical spacing between footer rows");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_footer_thumbnail_spacing", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_footer_thumbnail_spacing");
  RNA_def_property_range(prop, 0.0f, 32.0f);
  RNA_def_property_float_default(prop, 6.0f);
  RNA_def_property_ui_text(prop, "Thumbnail Spacing", "Spacing between attachment thumbnails");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_footer_thumbnail_size", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_footer_thumbnail_size");
  RNA_def_property_range(prop, 32.0f, 128.0f);
  RNA_def_property_float_default(prop, 48.0f);
  RNA_def_property_ui_text(prop, "Thumbnail Size", "Size of attachment thumbnails");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_footer_top_padding", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_footer_top_padding");
  RNA_def_property_range(prop, 0.0f, 32.0f);
  RNA_def_property_float_default(prop, 6.0f);
  RNA_def_property_ui_text(prop, "Footer Top Padding", "Padding above input field when no thumbnails are present");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_footer_thumbnail_top_margin", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_footer_thumbnail_top_margin");
  RNA_def_property_range(prop, 0.0f, 32.0f);
  RNA_def_property_float_default(prop, 8.0f);
  RNA_def_property_ui_text(prop, "Thumbnail Top Margin", "Vertical margin above attachment thumbnails");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_main_footer_gap", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_main_footer_gap");
  RNA_def_property_range(prop, 0.0f, 64.0f);
  RNA_def_property_float_default(prop, 16.0f);
  RNA_def_property_ui_text(prop, "Main-Footer Gap", "Internal spacing above the input field inside the footer");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_send_button_size", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_send_button_size");
  RNA_def_property_range(prop, 16.0f, 128.0f);
  RNA_def_property_float_default(prop, 40.0f);
  RNA_def_property_ui_text(prop, "Send Button Size", "Size of the send button icon");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_attach_button_size", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_attach_button_size");
  RNA_def_property_range(prop, 16.0f, 128.0f);
  RNA_def_property_float_default(prop, 40.0f);
  RNA_def_property_ui_text(prop, "Attach Button Size", "Size of the attachment button (paperclip) icon");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_footer_button_row_height", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_footer_button_row_height");
  RNA_def_property_range(prop, 8.0f, 128.0f);
  RNA_def_property_float_default(prop, 44.0f);
  RNA_def_property_ui_text(prop, "Footer Button Row Height", "Height of the footer button row");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "chat_footer_input_height", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_float_sdna(prop, nullptr, "chat_footer_input_height");
  RNA_def_property_range(prop, 20.0f, 400.0f);
  RNA_def_property_float_default(prop, 60.0f);
  RNA_def_property_ui_text(prop, "Footer Input Height", "Height of the multi-line text input field");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
}

static void rna_def_userdef_theme_space_agent_bubble(BlenderRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;
  ...
  srna = RNA_def_struct(brna, "ThemeAgentBubble", nullptr);
  RNA_def_struct_sdna(srna, "ThemeSpace");
  RNA_def_struct_ui_text(
      srna, "Theme Agent Bubble", "Theme settings for the floating Agent Bubble");
  ...
  RNA_def_property_array(prop, 4);
  RNA_def_property_float_array_default(prop, default_footer_bg);
  RNA_def_property_ui_text(
      prop, "Footer Background", "Background color for the input / send-button region");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  /* Background opacity — controls the alpha channel of the Window
   * Background colour.  Lower values let more of the OS blur-behind
   * effect (frosted glass) show through. */
  prop = RNA_def_property(srna, "background_alpha", PROP_FLOAT, PROP_FACTOR);
  RNA_def_property_float_funcs(
      prop, "rna_ThemeAgentBubble_bg_alpha_get", "rna_ThemeAgentBubble_bg_alpha_set", nullptr);
  RNA_def_property_range(prop, 0.0f, 1.0f);
  RNA_def_property_ui_text(
...
static void rna_def_userdef_theme_space_mixie(BlenderRNA *brna)
{
  ...
  RNA_def_property_ui_text(prop, "Text Input Background", "Background color for text input fields");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  RNA_def_property_ui_text(prop, "Text Input Text", "Text color for input fields");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  RNA_def_property_ui_text(prop, "Text Input Border", "Border color for text input fields");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  RNA_def_property_ui_text(prop, "Button Background", "Background color for buttons");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  RNA_def_property_ui_text(prop, "Button Text", "Text color for buttons");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  RNA_def_property_ui_text(prop, "Button Hover", "Button hover overlay color");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  RNA_def_property_ui_text(prop, "Panel Background", "Background color for panels");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  RNA_def_property_ui_text(prop, "Label Text", "Text color for labels");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  RNA_def_property_float_default(prop, 1.0f);
  RNA_def_property_ui_text(prop, "Input Border Width", "Border width for text input fields");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
  ...
  RNA_def_property_float_default(prop, 8.0f);
  RNA_def_property_ui_text(prop, "Corner Radius", "Corner radius for rounded UI elements");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
}
...
static void rna_def_userdef_themes(BlenderRNA *brna)
{
  ...
  RNA_def_property_flag(prop, PROP_NEVER_NULL);
  RNA_def_property_pointer_sdna(prop, nullptr, "space_agent_bubble");
  RNA_def_property_struct_type(prop, "ThemeAgentBubble");
  RNA_def_property_ui_text(prop, "Agent Bubble", "Theme settings for the floating Agent Bubble");
  /* end space types */
