...
/* STATUS */
DEF_ICON(STATUS_ERROR)
DEF_ICON(STATUS_ERROR_FILLED)
DEF_ICON(STATUS_INFO)
DEF_ICON(STATUS_INFO_FILLED)
DEF_ICON(STATUS_WARNING)
DEF_ICON(STATUS_WARNING_FILLED)
...
DEF_ICON(GRIP)
DEF_ICON(GRIP_V)
DEF_ICON(GRIP_CORNER_BOTTOM_RIGHT)
DEF_ICON(HAND)
DEF_ICON(HELP)
DEF_ICON(LINKED)
DEF_ICON(MENU_PANEL)
...
/* GREASE PENCIL */
DEF_ICON(GP_DRAW_STROKE)
DEF_ICON(GP_DRAW_FILL)
DEF_ICON(GP_DRAW_BOTH)
...
DEF_ICON(RENDER_SWAP_DIMENSIONS)
...
DEF_ICON_VECTOR(PACKAGE_INDIRECT)
...
DEF_ICON_VECTOR(NODE_SOCKET_FONT)
DEF_ICON_VECTOR(NODE_SOCKET_SCENE)
DEF_ICON_VECTOR(NODE_SOCKET_TEXT)
DEF_ICON_VECTOR(NODE_SOCKET_MASK)
DEF_ICON_VECTOR(NODE_SOCKET_SOUND)
