...
function(remove_macos_sdk_usr_include_dirs
  include_var
  )
  if(NOT DEFINED ${include_var})
    return()
  endif()

  set(_filtered_include_dirs)
  foreach(_include_dir IN LISTS ${include_var})
    if(_include_dir MATCHES "/MacOSX[^/]*\\.sdk/usr/include/?$")
      if(FIRST_RUN)
        message(STATUS
          "Omitting ${_include_dir} from ${include_var}; covered by CMAKE_OSX_SYSROOT"
        )
      endif()
    else()
  ...
  endforeach()
  set(${include_var} "${_filtered_include_dirs}" PARENT_SCOPE)
endfunction()
